...
First, I will add concatenate the cases of player one and player two together and filter out the ties.
...
# pie(ties$n, labels = c("No Tie", "Tie"), col = c("yellow", "black"), main = "Proportion of Tied Map Votes")
```
...
Join this table with the CODMaps table

```{r}

favorite_season <- map_totals %>% full_join(CODMaps, by = "Map") %>% 
