...
MSE_lasso1se <- mean((y - lasso.pred2)^2)
...
lm(formula = Score ~ TotalXP + Eliminations + Deaths + Damage + XPType + Win, data = tdm)
...
lm(formula = Score ~ TotalXP + Eliminations + Deaths + XPType + Win, data = tdm)
